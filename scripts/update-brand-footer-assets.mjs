...
async function walk(dir) {
  for (const item of await fs.readdir(dir,{withFileTypes:true})) {
    ...
    let after = before.replace(/local-navigation\.js\?v=[^"\s]+/g,'local-navigation.js?v=20260913-studio1')
      .replace(/brand-footer\.css\?v=[^"\s]+/g,'brand-footer.css?v=20260913-studio1');
    if (!after.includes('brand-footer.css')) after = after.replace('</head>','<link rel="stylesheet" href="brand-footer.css?v=20260913-studio1">\n</head>');
    if (!after.includes('mobile-refinement.css')) after = after.replace('</head>','<link rel="stylesheet" href="mobile-refinement.css?v=20260913-studio1">\n</head>');
