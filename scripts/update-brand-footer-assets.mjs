...
async function walk(dir) {
  for (const item of await fs.readdir(dir,{withFileTypes:true})) {
    ...
    let after = before.replace(/local-navigation\.js\?v=[^"\s]+/g,'local-navigation.js?v=20260911-glass5');
    if (!after.includes('brand-footer.css')) after = after.replace('</head>','<link rel="stylesheet" href="brand-footer.css?v=20260911-glass5">\n</head>');
