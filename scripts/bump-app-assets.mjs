...
async function walk(dir){for(const item of await fs.readdir(dir,{withFileTypes:true})){
 ...
 const after=before.replace(/((?:local-navigation\.js|site-experience\.mjs|brand-footer\.mjs|mobile-refinement\.mjs|brand-footer\.css|mobile-refinement\.css)\?v=)[\w-]+/g,'$120260913-studio3');
